                ...
                <div className="card1">
                    <div className="pre1">
                        ...
                        <div className="learnMore">
                            <img src="./ImgForHome/iconArrowForCards.svg" alt="" />
                            <p>Learn more</p>
                        </div>
                    </div>

                    <img src="./ImgForHome/card1.svg" alt="" />
                </div>
                <div className="card2">
                    <div className="pre2">
                    ...
                    <img src="./ImgForHome/card2.svg" alt="" />
                </div>
                <div className="card3">
                    <div className="pre3">
                    ...
                    <img src="./ImgForHome/card3.svg" alt="" />
                </div>
                <div className="card4">
                    <div className="pre4">
                    ...
                    <img src="./ImgForHome/card4.svg" alt="" />
                </div>
                <div className="card5">
                    <div className="pre5">
                    ...
                    <img src="./ImgForHome/card5.svg" alt="" />
                </div>
                <div className="card6">
                    <div className="pre6">
                    ...
                    <img src="./ImgForHome/card6.svg" alt="" />
                </div>
            </div>
        </>
    );
